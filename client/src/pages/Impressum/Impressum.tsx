    ...
    return (
        <div className={style.body}>
            ...
            <div className={style.section}>
                ...
                Dessen Kontaktdaten können Sie dem oben bereitgestellten Impressum entnehmen.</p>
                ...
                <p>Alle erhobenen Daten dienen ausschließlich der sicheren und fehlerfreien Bereitstellung dieser Website sowie der Durchführung von Sicherheitsanalysen.
                Eine Weitergabe an Dritte erfolgt nur mit Ihrer ausdrücklichen Zustimmung.</p>
                ...
                <h3>Hetzner</h3>
                <br />
                <p>Details entnehmen Sie der Datenschutzerklärung von Hetzner: <a href='https://www.hetzner.com/de/legal/privacy-policy/'>https://www.hetzner.com/de/legal/privacy-policy/</a>.</p>
                <br />
                <p>Die Verwendung von Hetzner erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website.
                ...
                Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gewährleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.</p>
                <br />
                ...
                Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend den gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.</p>
                ...
                <br />
                <h3>3.4. Empfänger von personenbezogenen Daten</h3>
                <br />
                ...
                Im Falle einer gemeinsamen Verarbeitung wird ein Vertrag über gemeinsame Verarbeitung geschlossen.</p>
                <br />
                ...
                <br />
                <h3>3.6. Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
                <br />
                ...
                <br />
                <h3>3.7. Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
                <br />
                ...
                <br />
                <h3>3.8. Recht auf Datenübertragbarkeit</h3>
                <br />
                ...
                <br />
                <h3>3.9. Auskunft, Berichtigung und Löschung</h3>
                <br />
                ...
                Hierzu können Sie sich jederzeit an uns wenden. Das Recht auf Einschränkung der Verarbeitung besteht in folgenden Fällen:</p>
                <br />
                <ul>
                ...
                <h3>4.1. Cookies</h3>
                <br />
                <p>Unsere Internetseiten verwenden so genannte „Cookies“. Cookies sind kleine Datenpakete und richten auf Ihrem Endgerät keinen Schaden an.
                ...
                Session-Cookies werden nach Ende Ihres Besuchs automatisch gelöscht. Permanente Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen oder eine automatische Löschung durch Ihren Webbrowser erfolgt.</p>
                ...
                Andere Cookies können zur Auswertung des Nutzerverhaltens oder zu Werbezwecken verwendet werden.</p>
                <p>Cookies, die zur Durchführung des elektronischen Kommunikationsvorgangs, zur Bereitstellung bestimmter, von Ihnen erwünschter Funktionen (z. B. für eine Warenkorbfunktion) oder zur Optimierung der Website (z. B. Cookies zur Messung des Webpublikums) erforderlich sind (notwendige Cookies), werden auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird.</p>
                ...
                <p>Sie können Ihren Browser so einstellen, dass Sie über das Setzen von Cookies informiert werden und Cookies nur im Einzelfall erlauben, die Annahme von Cookies für bestimmte Fälle oder generell ausschließen sowie das automatische Löschen der Cookies beim Schließen des Browsers aktivieren.
                ...
                <br />
                <p>Die Erfassung und Speicherung Ihrer E-Mail-Adresse erfolgt nicht automatisiert, sondern ausschließlich manuell und nur mit Ihrer ausdrücklichen Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
                Die E-Mail-Adresse wird benötigt, um einen reibungslosen Anmeldeprozess sicherzustellen.</p>
                <br />
                <h3>4.3. Server-Logfiles</h3>
                <br />
                <p>Ihre IP-Adresse wird anonymisiert in unseren Server-Logfiles gespeichert, um sicherheitsrelevante Ereignisse zu protokollieren und die Systemstabilität sicherzustellen.
                Die Verarbeitung erfolgt auf Grundlage unseres berechtigten Interesses gemäß Art. 6 Abs. 1 lit. f DSGVO, die Integrität, Verfügbarkeit und Sicherheit unserer informationstechnischen Systeme zu gewährleisten.
                Eine Zusammenführung dieser Daten mit anderen personenbezogenen Informationen erfolgt nicht. Die Daten werden regelmäßig gelöscht, sofern sie nicht zur Aufklärung sicherheitsrelevanter Vorfälle erforderlich sind.</p>
            </div>
            <Footer />
        </div>
    );
